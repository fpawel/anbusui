...
type
    ...
    TChartsSvc = class
    public
        class function BucketsOfYearMonth(Year: Integer; Month: Integer)
          : TArray<TChartsBucket>; static;
        class function DeletePoints(BucketID: Int64; Addr: Byte; VarCode: Word;
          ValueMinimum: Double; ValueMaximum: Double; TimeMinimum: TTimeDelphi;
          TimeMaximum: TTimeDelphi): Int64; static;
    ...
    public
        ...
        class procedure Write32(Addr: Integer; Cmd: Word;
          Value: Double); static;
...
begin
    ...
    SuperObject_Get(ThttpRpcClient.GetResponse('ConfigSvc.ComportName',
      req), Result);
end;
...
begin
    ...
    SuperObject_Get(ThttpRpcClient.GetResponse('ConfigSvc.GetEditConfig',
      req), Result);
end;
...
begin
    ...
    SuperObject_Get(ThttpRpcClient.GetResponse('ConfigSvc.SetEditConfig',
      req), Result);
end;
...
class function TChartsSvc.BucketsOfYearMonth(Year: Integer; Month: Integer)
  : TArray<TChartsBucket>;
var
    req: ISuperobject;
    s: string;
begin
...
class function TChartsSvc.DeletePoints(BucketID: Int64; Addr: Byte;
  VarCode: Word; ValueMinimum: Double; ValueMaximum: Double;
  TimeMinimum: TTimeDelphi; TimeMaximum: TTimeDelphi): Int64;
var
    req: ISuperobject;
    s: string;
begin
    ...
    TgoBsonSerializer.serialize(TimeMinimum, s);
    req['TimeMinimum'] := SO(s);
    TgoBsonSerializer.serialize(TimeMaximum, s);
    req['TimeMaximum'] := SO(s);

    SuperObject_Get(ThttpRpcClient.GetResponse('ChartsSvc.DeletePoints',
      req), Result);
end;
